...
public class CredentialOfferFormParam {
  ...
  public CredentialOfferFormParam(boolean preAuthCodeFlow, List<String> availableCredentials,
      List<String> selectedCredentials, String message) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof CredentialOfferFormParam that))
      return false;
    return preAuthCodeFlow == that.preAuthCodeFlow
        && Objects.equals(availableCredentials, that.availableCredentials)
        && Objects.equals(selectedCredentials, that.selectedCredentials)
