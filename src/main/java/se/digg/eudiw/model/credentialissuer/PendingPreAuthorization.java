...
public class PendingPreAuthorization {
  ...
  public PendingPreAuthorization(CredentialOfferParam credentialOfferParam, String redirectUri,
      CodeVerifier codeVerifier, String clientId, String txCode, SwedenConnectPrincipal principal) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PendingPreAuthorization that))
      return false;
    return Objects.equals(credentialOfferParam, that.credentialOfferParam)
        && Objects.equals(redirectUri, that.redirectUri)
        && Objects.equals(codeVerifier, that.codeVerifier)
        && Objects.equals(clientId, that.clientId) && Objects.equals(txCode, that.txCode)
        && Objects.equals(principal, that.principal);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credentialOfferParam, redirectUri, codeVerifier, clientId, txCode,
        principal);
  }
