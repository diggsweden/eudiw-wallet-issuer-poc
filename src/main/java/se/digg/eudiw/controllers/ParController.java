...
public class ParController {
  ...
  public ParController(@Autowired ParCacheService parRequestStore/*
                                                                  * , @Autowired EudiwConfig
                                                                  * eudiwConfig
                                                                  */) {
  ...
  public ResponseEntity<Map<String, Object>> handleParRequest(
      @RequestBody MultiValueMap<String, String> requestParams) {
    // Validate incoming parameters
    /*
     * if (!requestParams.containsKey("client_id")) { return ResponseEntity.badRequest(); }
     */
    ...
    requestParams.add(OAuth2ParameterNames.GRANT_TYPE,
    ...
    /*
     * Map.of( "request_uri", requestUri, "expires_in", PAR_REQUEST_TTL // Expiration in seconds ));
     */
  }
