...
public class MetadataController {
  ...
  public MetadataController(EudiwConfig eudiwConfig,
      OpenIdFederationService openIdFederationService, SignerConfig signer,
  ...
  @RequestMapping(value = "/.well-known/openid-federation",
      produces = "application/TODO_ENTITY_STATEMENT_TYPE")
  public ResponseEntity<String> entityStatement() {
    ...
    try {
      ...
      final EntityMetadataInfoClaim entityMetadataInfoClaim = EntityMetadataInfoClaim.builder()
          .federationEntityMetadataObject(
              FederationEntityMetadata.builder()
                  .organizationName(
                      LanguageObject.builder(String.class).defaultValue("DIGG").build())
                  .build().toJsonObject())
          .build();
      entityMetadataInfoClaim.setMetadataClaimsObject("openid_credential_issuer",
      ...
      final EntityStatementDefinedParams definedParams =
          EntityStatementDefinedParams.builder()
              ...
              .sourceEndpoint(String.format("%s/%s", eudiwConfig.getIssuerBaseUrl(),
              ...
              .trustMarks(List.of(TrustMarkClaim.builder()
                  ...
                  .trustMark(openIdFederationService.trustMark(
                      eudiwConfig.getOpenidFederation().trustMarkId(),
                      eudiwConfig.getOpenidFederation().subject()))
                  .build()))
              .build();
    ...
    } catch (JsonProcessingException | NoSuchAlgorithmException | JOSEException
