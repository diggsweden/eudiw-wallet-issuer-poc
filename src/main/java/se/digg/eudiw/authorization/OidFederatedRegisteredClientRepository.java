...
public class OidFederatedRegisteredClientRepository implements RegisteredClientRepository {
  ...
  public OidFederatedRegisteredClientRepository(EudiwConfig config/*
                                                                   * , OpenIdFederationService
                                                                   * openIdFederationService
                                                                   */) {
    this.config = config;
    ...
    ConcurrentHashMap<String, RegisteredClient> clientIdRegistrationMapResult =
  ...
  private RegisteredClient buildRegisteredClient(String clientId) {
    ...
    registeredClientBuilder = registeredClientBuilder
        .redirectUri(
            String.format("%s/login/oauth2/code/messaging-client-pkce", config.getIssuerBaseUrl()))
