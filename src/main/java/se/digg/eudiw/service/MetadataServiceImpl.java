...
public class MetadataServiceImpl implements MetadataService {
  ...
  public CredentialIssuerMetadata metadata()
    ...
    CredentialIssuerMetadata.CredentialIssuerMetadataBuilder metadataBuilder =
        CredentialIssuerMetadata.builder()
            ...
            .deferredCredentialEndpoint(
                String.format("%s/credential_deferred", eudiwConfig.getCredentialHost()))
            ...
            .display(List.of(
                Display.builder()
                    .name("DIGG issuer")
                    .logo(new Display.Image(
                        String.format("%s/images/digg_logo.jpeg", eudiwConfig.getIssuerBaseUrl()),
                        "DIGG logotype"))
                    .locale("en")
                    .build(),
                Display.builder()
                ...
                Display.builder()
                    ...
                    .locale("de")
                    .build()))
            .credentialConfiguration("eu.europa.ec.eudi.pid_mdoc", IsoMdlCredentialConfiguration
                .builder()
                .claim(Claim.builder()
                ...
                .proofType("cwt",
                    MetadataServiceImpl.ProofTypeWrapper.createProofType(List.of("ES256")))
                .proofType("jwt",
                    MetadataServiceImpl.ProofTypeWrapper.createProofType(List.of("ES256")))
                .display(List.of(
                    Display.builder()
                        ...
                        .locale("en")
                        .logo(new Display.Image(String.format("%s/images/digg_logo.jpeg",
                            eudiwConfig.getIssuerBaseUrl()), "DIGG logotype"))
                        .build(),
                    Display.builder()
                    ...
                    Display.builder()
                        ...
                        .build()))
                .build())
            .credentialConfiguration("eu.europa.ec.eudi.pid_jwt_vc_json",
                SdJwtCredentialConfiguration.builder()
                    .format("dc+sd-jwt")
                    .scope("eu.europa.ec.eudi.pid.1")
                    ...
                    .claim(Claim.builder()
                        ...
                        .display(List.of(
                            ...
                            Display.builder()
                                ...
                                .build()))
                        .build())
                    // family_name is not specified in ARF, however it is the IANA name and should
                    // be present in sd jwt vc https://www.iana.org/assignments/jwt/jwt.xhtml#claims
                    .claim(Claim.builder()
                    ...
                    .claim(Claim.builder()
                        ...
                        .display(List.of(
                            Display.builder()
                                ...
                                .build()))
                        .build())
                    // birthdate is not specified in ARF, however it is the IANA name and should be
                    // present in sd jwt vc https://www.iana.org/assignments/jwt/jwt.xhtml#claims
                    .claim(Claim.builder()
    ...
    if (eudiwConfig.isSignedMetaData()) {
      return metadataBuilder.buildWithSignedMetadata(signer.getJwtSigningCredential().getSigner(),
          JWSAlgorithm.ES256, signer.getJwtSigningCredential().getKid());
    }
